"""Pure waterfall config + allocation (no DB). Used when full _legacy repayment block is unavailable."""
...
_BUCKET_NAME_NORMALIZE["principal"] = "principal_arrears"
...
_BUCKET_NAME_NORMALIZE["interest"] = "interest_arrears_balance"
