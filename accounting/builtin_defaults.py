...
TRANSACTION_TEMPLATE_TUPLES: list[tuple[str, str, str, str, str]] = [
    ...
    ("REGULAR_INTEREST_BILLING_RECEIVABLE", "regular_interest_arrears", "DEBIT", "Regular interest billing: arrears from accrued (unbilled)", "EOD"),
    ("REGULAR_INTEREST_BILLING_RECEIVABLE", "regular_interest_accrued", "CREDIT", "Regular interest billing: arrears from accrued (unbilled)", "EOD"),
    ("EOM_REGULAR_INTEREST_INCOME_RECOGNITION", "regular_interest_income_holding", "DEBIT", "EOM recognition of regular interest income (MTD accrual)", "EOM"),
    ("EOM_REGULAR_INTEREST_INCOME_RECOGNITION", "regular_interest_income", "CREDIT", "EOM recognition of regular interest income (MTD accrual)", "EOM"),
    ...
    ("LOAN_RESTRUCTURE_CAPITALISE", "regular_interest_accrued", "CREDIT", "Capitalisation of regular interest accrued (restructure)", "EVENT"),
    ...
    ("AGENT_COMMISSION_ACCRUAL", "deferred_fee_commission_asset", "DEBIT", "Accrue agent commission as deferred asset", "EVENT"),
    ("AGENT_COMMISSION_ACCRUAL", "accrued_expenses", "CREDIT", "Accrue agent commission payable", "EVENT"),
    ("AGENT_COMMISSION_PAYMENT", "accrued_expenses", "DEBIT", "Settlement of accrued agent commission", "EVENT"),
    ("AGENT_COMMISSION_PAYMENT", "cash_operating", "CREDIT", "Settlement of accrued agent commission", "EVENT"),
