"""
Run schema migration 20_allocation_append_only.sql.
Append-only allocation events: drop unique on repayment_id, normalize event_type.

From project root:
  python scripts/run_migration_20.py
"""
import os
import sys
...
def main():
    ...
    sql_path = os.path.join(schema_dir, "20_allocation_append_only.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.close()
        print("Migration 20 (allocation append-only) applied successfully.")
