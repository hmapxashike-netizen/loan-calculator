"""
Run schema migration 21_unapplied_funds_ledger.sql.
Creates unapplied_funds_ledger for credits (+) and debits (-) audit.

From project root:
  python scripts/run_migration_21.py
"""
import os
import sys
...
def main():
    ...
    sql_path = os.path.join(schema_dir, "21_unapplied_funds_ledger.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.close()
        print("Migration 21 (unapplied_funds_ledger) applied successfully.")
